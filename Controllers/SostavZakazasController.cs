...
namespace WebApplication2.Controllers
{
    public class SostavZakazasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdSostavZakaza,MebelId,Price")] SostavZakaza sostavZakaza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSostavZakaza,MebelId,Price")] SostavZakaza sostavZakaza)
        {
