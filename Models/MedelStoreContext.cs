...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-9AHGKHV\\SQLEXPRESS;Initial Catalog=Medel_store;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAdress).HasName("PK__Adress__C0B17B21D2BC0745");
        ...
        {
            entity.HasKey(e => e.IdApplications).HasName("PK__Applicat__730CFFBD50F644B5");
            ...
            entity.HasOne(d => d.Clients).WithMany(p => p.Applications)
                ...
                .HasConstraintName("FK__Applicati__clien__5DCAEF64");

            entity.HasOne(d => d.Mebel).WithMany(p => p.Applications)
                .HasForeignKey(d => d.MebelId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Applicati__mebel__5CD6CB2B");

            entity.HasOne(d => d.Staff).WithMany(p => p.Applications)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Applicati__staff__5EBF139D");
        });

        modelBuilder.Entity<Categori>(entity =>
        {
            entity.HasKey(e => e.IdCategori).HasName("PK__Categori__AC5CA41EC6F40C5A");
        ...
        {
            entity.HasKey(e => e.IdClients).HasName("PK__Clients__9BB26545F0F94268");
            ...
            entity.HasOne(d => d.Adress).WithMany(p => p.Clients)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Clients__adress___44FF419A");

            entity.HasOne(d => d.Passport).WithMany(p => p.Clients)
                .HasForeignKey(d => d.PassportId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Clients__passpor__45F365D3");
        });

        modelBuilder.Entity<Mebel>(entity =>
        {
            entity.HasKey(e => e.IdMebel).HasName("PK__Mebel__CA7A396909F39453");
            ...
            entity.HasOne(d => d.Categori).WithMany(p => p.Mebels)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Mebel__categori___48CFD27E");
        });

        modelBuilder.Entity<Pasport>(entity =>
        {
            entity.HasKey(e => e.IdPasports).HasName("PK__Pasports__FBF6E1C1DB9E9240");
        ...
        {
            entity.HasKey(e => e.IdPositions).HasName("PK__Position__AD4231AB32E82981");
        ...
        {
            entity.HasKey(e => e.IdPostavchik).HasName("PK__Postavhi__287BBC758D86C3C5");
        ...
        {
            entity.HasKey(e => e.IdPostavki).HasName("PK__Postavki__5C79085BA0E22B95");
            ...
            entity.HasOne(d => d.Mebel).WithMany(p => p.Postavkis)
                .HasForeignKey(d => d.MebelId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Postavki__mebel___4CA06362");

            entity.HasOne(d => d.Postavchika).WithMany(p => p.Postavkis)
                .HasForeignKey(d => d.PostavchikaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Postavki__postav__4BAC3F29");
        });

        modelBuilder.Entity<SostavZakaza>(entity =>
        {
            entity.HasKey(e => e.IdSostavZakaza).HasName("PK__Sostav_z__A5C1194A88D1E6AE");
            ...
            entity.HasOne(d => d.Mebel).WithMany(p => p.SostavZakazas)
                .HasForeignKey(d => d.MebelId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Sostav_za__mebel__5165187F");
        });

        modelBuilder.Entity<Staff>(entity =>
        {
            entity.HasKey(e => e.IdStaff).HasName("PK__Staff__E04EF047CF9AA7DB");
            ...
            entity.HasOne(d => d.Passport).WithMany(p => p.Staff)
                .HasForeignKey(d => d.PassportId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Staff__passport___5812160E");

            entity.HasOne(d => d.Positions).WithMany(p => p.Staff)
                .HasForeignKey(d => d.PositionsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Staff__positions__59063A47");
        });
